...
class SimplePMM(ScriptStrategyBase):
    ...
    def call_trade_history(self, file_name='trades_TREMP.csv'):
    ...
    def did_fill_order(self, event: OrderFilledEvent):
        ...
        breakeven_buy_price, breakeven_sell_price, realized_pnl, net_value = self.call_trade_history('trades_TREMP')
