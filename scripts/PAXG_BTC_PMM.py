    ...
    def on_tick(self):
        ...
        if self.create_timestamp <= self.current_timestamp:
            ...
            self.wait_after_cancel_timestamp <= self.current_timestamp:
                ...
                # Update Timestamps
                self.wait_after_cancel_timestamp = self.current_timestamp + self.cancel_cooldown_duration + order_refresh_time   # e.g., 10 seconds
                self.wait_after_fill_timestamp = self.current_timestamp + self.fill_cooldown_duration + order_refresh_time  # e.g., 10 seconds
